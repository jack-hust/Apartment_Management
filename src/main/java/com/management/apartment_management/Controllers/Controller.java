...
public class Controller implements Initializable {
    ...
    public void loadScene2() throws Exception {
        ...
        Parent parent = FXMLLoader.load(getClass().getResource("../../../../../../../../../src/sample/RRMSscene2.fxml"));
    ...
    public void loadRegster() throws Exception {
        // This loads the main Windows
        Stage mainStage = new Stage();
        Parent parent = FXMLLoader.load(getClass().getResource("../../../../../../../../../src/sample/RRMSregisterScene.fxml"));
        Scene scene = new Scene(parent);
    ...
    public void regCustomer() throws IOException {
        ...
        Parent parent = FXMLLoader.load(getClass().getResource("../../../../../../../../../src/sample/RRMSregisterCustomerScene.fxml"));
        borderPan.setLeft(null);
        borderPan.setCenter(parent);
    }

    public void customerView() throws IOException {
        Parent parent = FXMLLoader.load(getClass().getResource("../../../../../../../../../src/sample/RRMSCustomerViewScene.fxml"));
        borderPan.setCenter(null);
        borderPan.setLeft(parent);
    }

    public void availableRooms() throws IOException {
        Parent parent = FXMLLoader.load(getClass().getResource("../../../../../../../../../src/sample/RRMSavailableRoomsScene.fxml"));
        borderPan.setCenter(null);
        borderPan.setLeft(parent);
    }
    ...
    public void addAptmnt() throws IOException {
        ...
        Parent parent = FXMLLoader.load(getClass().getResource("../../../../../../../../../src/sample/RRMSaddApartmentScene.fxml"));
        borderPan.setLeft(null);
        borderPan.setCenter(parent);
    }
